<div class="row">
    <div class="col-md-5">
                ...
                <div class="input-group">
                    <div class="input-group date timepicker" id="timepicker_check_in_time" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input"
                            data-target="#timepicker_check_in_time" value="{{ $settings[0]->value }}"
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <div class="input-group date timepicker" id="timepicker_check_out_time" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input"
                            data-target="#timepicker_check_out_time" value="{{ $settings[1]->value }}"
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <div class="input-group date timepicker" id="timepicker_lunch_time_start"
                        ...
                        <input type="text" class="form-control datetimepicker-input"
                            data-target="#timepicker_lunch_time_start" value="{{ $settings[4]->value }}"
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <div class="input-group date timepicker" id="timepicker_lunch_time_end"
                        data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input"
                            data-target="#timepicker_lunch_time_end" value="{{ $settings[5]->value }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[6]->value }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[9]->value }}"
    ...
    <div class="col-md-5">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[12]->value }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[13]->value }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[14]->value }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[15]->value }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[16]->value }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="number" class="form-control" value="{{ $settings[17]->value }}"
